...
class path_publisher:
    def __init__(self):
        ...
        command_path_topic = param['command_path_topic'] # TODO: remove
        ellipse_topic = param['ellipse_topic'] # TODO: remove

        self.path_frame = param['path_frame_id']

        self.world_dim = param['world_dimension'] # TODO: remove(?)
        ...
        self.ellipse_pub = rospy.Publisher(ellipse_topic,Marker,queue_size=10) # TODO: remove
